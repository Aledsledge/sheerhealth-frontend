...
const DoctorCard = ({ doctor }) => {
  ...
  return (
    <div className="p-3 lg:p-5 bg-white items-center justify-center shadow-md rounded-lg">
      <div>
        <img src={photo} className="w-full rounded-lg" alt="" />
      </div>
      <h2 className="text-[18px] lg:text-[26px] font-semibold text-headingColor mt-3 lg:mt-5">
        {name}
      </h2>
      ...
      <div className="mt-[18px] lg:mt-5 flex items-center justify-between">
        <div>
          ...
          <p className="text-[14px] font-normal text-textColor">At {hospital}</p>
        </div>
        <Link
          to="/doctors"
          className="w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-3 lg:mt-0 mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none"
        >
